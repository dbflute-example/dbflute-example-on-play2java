...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("member", "dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("member_address", "dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("member_following", "dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("member_login", "dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("member_security", "dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("member_service", "dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("member_status", "dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("member_withdrawal", "dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("product", "dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("product_category", "dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("product_status", "dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("purchase", "dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("purchase_payment", "dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("region", "dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("service_rank", "dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("summary_product", "dbflute.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("summary_withdrawal", "dbflute.bsentity.dbmeta.SummaryWithdrawalDbm");
        tmpMap.put("withdrawal_reason", "dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
