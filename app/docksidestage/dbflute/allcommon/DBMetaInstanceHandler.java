...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("member", "docksidestage.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("member_address", "docksidestage.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("member_following", "docksidestage.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("member_login", "docksidestage.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("member_security", "docksidestage.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("member_service", "docksidestage.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("member_status", "docksidestage.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("member_withdrawal", "docksidestage.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("product", "docksidestage.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("product_category", "docksidestage.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("product_status", "docksidestage.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("purchase", "docksidestage.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("purchase_payment", "docksidestage.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("region", "docksidestage.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("service_rank", "docksidestage.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("summary_product", "docksidestage.dbflute.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("summary_withdrawal", "docksidestage.dbflute.bsentity.dbmeta.SummaryWithdrawalDbm");
        tmpMap.put("withdrawal_reason", "docksidestage.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
