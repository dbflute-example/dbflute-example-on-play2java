...
public class MemberDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnMemberName = cci("MEMBER_NAME", "MEMBER_NAME", null, "会員名称", String.class, "memberName", null, false, false, true, "VARCHAR", 180, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "docksidestage.dbflute.exentity.Member"; }
    public String getConditionBeanTypeName() { return "docksidestage.dbflute.cbean.MemberCB"; }
    public String getBehaviorTypeName() { return "docksidestage.dbflute.exbhv.MemberBhv"; }
